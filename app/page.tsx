...
export default function Home() {
  ...
  return (
    <main className="relative">
      ...
      <div className="pointer-events-none absolute right-4 top-4 z-40 flex flex-col items-end gap-2.5 sm:right-6 sm:top-6">
        <AuthBadge />
        <Link
          href="/library"
          className="group pointer-events-auto flex items-center gap-2.5 rounded-xl border border-line-strong bg-panel/90 px-4 py-2.5 font-mono text-[11px] font-bold uppercase tracking-[0.22em] text-fog shadow-[0_8px_24px_rgba(0,0,0,0.45)] backdrop-blur transition-all duration-300 hover:-translate-y-0.5 hover:border-white hover:bg-raised hover:text-white hover:shadow-glow"
        >
          <span className="text-sm leading-none">📚</span>
          <span>my library</span>
          <span className="ml-1 inline-block h-1.5 w-1.5 rounded-full bg-accent opacity-70 transition-opacity duration-300 group-hover:opacity-100" />
